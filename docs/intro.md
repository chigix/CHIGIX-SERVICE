...
* **作为扩展机制加入到现有的应用级开发框架中，降低学习成本，提升开发平滑迁移**
	...
	本架构实为MVC框架的一个扩展机制，所以安装本架构就变得十分简单。本版本仅可用于ThinkPHP 3.1.0以上版本，对于符合版本要求的THinkPHP项目可以直接迁移到千木架构之上，而对于低于该版本要求的 ThinkPHP 项目，请根据ThinkPHP自带的升级指南，将项目代码修改至兼容版本后，亦可平滑过渡到本架构之上。
